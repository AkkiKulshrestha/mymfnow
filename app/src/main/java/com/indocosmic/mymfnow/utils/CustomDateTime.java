...
/**
 * Created by devashree on 1/4/16.
 */
...
public class CustomDateTime implements View.OnClickListener {
    ...
    public CustomDateTime(Activity a,
                          ICustomDateTimeListener customDateTimeListener) {
        activity = a;
        iCustomDateTimeListener = customDateTimeListener;

        dialog = new Dialog(activity);
       /* dialog.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() {
